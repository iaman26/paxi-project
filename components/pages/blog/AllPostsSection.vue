...
<template>
  <section
    class="flex w-full flex-col items-center justify-center self-stretch bg-[#F9F9F9] px-[5%] py-12 max-md:max-w-full lg:px-[7%] xl:px-[10%]"
  >
