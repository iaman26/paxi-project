...
defineProps({
  cultures: {
    type: Array as PropType<ICultureProps[]>,
    default: () => [
      {
        icon: '',
        title: '',
...
<template>
  <section
    class="flex w-full flex-col items-center justify-center self-stretch bg-[#FAFAFC] px-[5%] py-12 max-md:max-w-full lg:px-[7%] xl:px-[10%]"
  >
